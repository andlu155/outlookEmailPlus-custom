(function () {
    ...
    const exactMap = {
        ...
        '搜索邮箱 / 备注 / 标签…': 'Search email / remark / tags…',
        '当前分组': 'Current group',
        '全部账号': 'All accounts',
        '清空搜索': 'Clear search',
        '搜索范围': 'Search scope',
        ...
        '请从左侧选择一个邮箱账号': 'Select an account from the left',
        '该分组暂无邮箱': 'No mailboxes in this group',
        '暂无账号': 'No accounts',
        '未找到匹配账号，试试切换到「全部账号」或清空筛选': 'No matching accounts. Try “All accounts” or clear filters',
        '未找到匹配账号，试试切换范围或清空筛选': 'No matching accounts. Try switching scope or clearing filters',
        '搜索中…': 'Searching…',
        ...
        '关键词': 'Keyword',
        '清除筛选': 'Clear filters',
        '点击账号可定位到所属分组': 'Click an account to jump to its group',
        '个标签': 'tags',
        '数据库备份': 'Database Backup',
        '下载 SQLite 快照': 'Download SQLite snapshot',
        '下载备份': 'Download backup',
        '正在生成备份…': 'Generating backup…',
        '备份已开始下载': 'Backup download started',
        '数据库备份已开始下载': 'Database backup download started',
        ...
        '状态刷新': 'Status Refresh',
        '同步分裂': 'Status Refresh',
        '批量同步分裂地址': 'Batch status refresh (status + aliases)',
        '正在批量同步分裂地址…': 'Refreshing status and aliases…',
        '分裂地址同步完成': 'Status refresh finished',
        '分裂地址同步失败': 'Status refresh failed',
        '请选择要同步分裂地址的账号': 'Please select accounts for status refresh',
        '请选择要状态刷新的账号': 'Please select accounts for status refresh',
        '单次最多同步 20 个账号的分裂地址': 'At most 20 accounts can be refreshed per batch',
        '失效': 'Inactive',
        '有分裂': 'Has Aliases',
        '无分裂': 'No Aliases',
        '已刷新': 'Refreshed',
        ...
        '已同步': 'Refreshed',
        '未同步': 'Not Refreshed',
        '正在状态刷新…': 'Refreshing status…',
        '正在同步分裂地址…': 'Refreshing status…',
        '已取消状态刷新': 'Status refresh cancelled',
        '已取消同步分裂地址': 'Status refresh cancelled',
        '状态刷新完成': 'Status refresh finished',
        '状态刷新失败': 'Status refresh failed',
        '状态刷新进行中，请稍候或先取消': 'Status refresh is already running. Wait or cancel first.',
        '正在取消…': 'Cancelling…',
        '已取消': 'Cancelled',
        '取消': 'Cancel',
        '分裂地址同步进行中，请稍候或先取消': 'Status refresh is already running. Wait or cancel first.',
        '尚未同步分裂数量，可勾选后点「同步分裂」': 'Not refreshed yet. Select accounts and click Status Refresh.',
        '点击状态刷新': 'Click to refresh status',
        '点击同步分裂数量': 'Click to refresh status',
        '已使用的分裂地址数量': 'Used plus-address alias count',
