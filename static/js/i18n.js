(function () {
    ...
    const exactMap = {
        ...
        '📧 邮箱名': '📧 Email',
        '同步分裂': 'Sync Aliases',
        '批量同步分裂地址': 'Batch sync plus-address aliases',
        '正在批量同步分裂地址…': 'Batch-syncing plus-address aliases…',
        '分裂地址同步完成': 'Alias sync finished',
        '分裂地址同步失败': 'Alias sync failed',
        '请选择要同步分裂地址的账号': 'Please select accounts to sync aliases',
        '单次最多同步 20 个账号的分裂地址': 'At most 20 accounts can be synced per batch',
        '失效': 'Inactive',
        '有分裂': 'Has Aliases',
        '无分裂': 'No Aliases',
        '已同步': 'Synced',
        '未同步': 'Unsynced',
        '正在同步分裂地址…': 'Syncing aliases…',
        '已取消同步分裂地址': 'Alias sync cancelled',
        '正在取消…': 'Cancelling…',
        '已取消': 'Cancelled',
        '取消': 'Cancel',
        '分裂地址同步进行中，请稍候或先取消': 'Alias sync is already running. Wait or cancel first.',
        '尚未同步分裂数量，可勾选后点「同步分裂」': 'Alias count not synced yet. Select accounts and click Sync Aliases.',
